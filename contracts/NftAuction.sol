    ...
    IERC721Receiver
{
    ...
    function startAuction(
        ...
        require(
            ...
            "Contract is not approved to manage your NFT"
        );
        // 拍卖ID自增
    ...
    function placeBid(
        ...
        address _token,
        uint256 amount
    ) public payable virtual nonReentrant auctionActive(auctionId) {
        ...
        if (a.highestBidder != address(0)) {
            if (a.highestBidderToken == address(0)) {
                (bool success, ) = payable(a.highestBidder).call{
                    value: a.highestBid
                }("");
                require(success, "Transfer failed");
            } else {
                IERC20(a.highestBidderToken).transfer(
                    a.highestBidder,
                    a.highestBid
                );
            }
    ...
    function endAuction(uint256 auctionId) auctionActive(auctionId) virtual public {
